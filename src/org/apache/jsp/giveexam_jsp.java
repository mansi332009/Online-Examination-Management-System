...
public final class giveexam_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.print(s);
      out.write("\" name=\"test_no\"  />\n");
      out.write("            <center>\n");
      out.write("            <p style=\"font-family:Lucida Console;\"> Enter Your Student ID : (Make sure this is Your Smart ID at University)</p>\n");
      out.write("                          <p style=\"margin-bottom:60px;font-family:Lucida Console;\">  <input type=\"text\" name=\"id\" value=\"id\" size=\"50\" /></p>\n");
               ...
               try {
                        ...
                        while(rs.next())
                        {
                           ...
                           // out.println(request.getParameter("exam"));
                            if(((rs.getString(10)).toString()).equals(request.getParameter("exam").toString()))
                            {
      ...
      out.write("\n");
      out.write("                 </table> \n");
      out.write("                 <input type=\"submit\" style=\"margin-top: 30px;height: 40px;width: 70px;font:7 bold;background-color: #32527b; color:white;\n");
