...
public class adminTestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("</script>");
                         ...
                         RequestDispatcher rd=request.getRequestDispatcher("adminTestReg.jsp");  
...
if (regTest.saveTest(st)) {
    ...
    request.getRequestDispatcher("adminExamReg.jsp").forward(request, response);   
} else {
    String errorMessage = "User Available";
    HttpSession regSession = request.getSession();
    regSession.setAttribute("RegError", errorMessage);
    response.sendRedirect("adminTestReg.jsp");
    request.getRequestDispatcher("adminTestReg.jsp").forward(request, response);
    }
}
