<%-- 
    Document   : TestReg
    Created on : Mar 7, 2021, 4:27:59 PM
    Author     : Mansi
--%>
...
a:hover {
    ...
    <body>   
        ...
        <div class="content" align="center">
            ...
            <form action="TestServlet?teacher_id=<%=request.getParameter("teacher_id")%>" method="post" >
        ...
        <span class="details">Seconds
            <input id="sec" type="text" placeholder=" Enter Seconds " name="test_sec"> </span>
            <p id="msg"></p>
      </div>
      </div> 
        ...
        <div class="button">
            ...
            <a href="choosequestions?teacher_id=<%=request.getParameter("teacher_id")%>"></a>
        </div>
        </div>
            </form>
           </div> 
