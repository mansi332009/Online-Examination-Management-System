<%-- 
    Document   : choosequestions
    Created on : 3 May, 2021, 5:40:42 PM
    Author     : Mansi
--%>
        ...
        <div class="content" align="center">
            ...
            <form method="post" >
                <div class="user-details">
                    <input type="text" name="test_id" value=<%=request.getParameter("test_id")%> style="display:none">
                <div class="input-box">
                    <input type="text" name="teacher_id" value=<%=request.getParameter("teacher_id")%> style="display:none">
                    <a class="details" href="addquestion.jsp?test_id=<%= request.getParameter("test_id")%>& teacher_id=<%=request.getParameter("teacher_id")%>"><input class ="new" type="button" value="Select The Questions" /></a>  
                     <a class="details" href="ExamReg.jsp?teacher_id=<%=request.getParameter("teacher_id")%>"><input class ="new" type="button" value="Add Manually" /></a>     
                </div>
