<%-- 
    Document   : adminsuccessfull
    Created on : 20 Apr, 2021, 12:33:28 PM
    Author     : Mansi
--%>
    ...
    <body>
        ...
        <div class="content" align="center">
            ...
            <form method="post" >
                ...
                <div class="input-box">
                    <a class="details" href="adminExamReg.jsp?test_id=<%=request.getParameter("test_id")%>"><input class ="new" type="button" value="Add More Questions" name="Add More Questions"/></a>
                    <a class="details"><button type="button" onclick="func()">Create Test</button></a>    
                     <a class="details" href="preview.html"><input class ="new" type="button" value="Preview Test" name="Preview Test"/></a>     
                </div>
                </div>
            </form>
           </div> 
